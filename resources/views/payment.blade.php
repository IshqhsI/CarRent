    ...
    <section class="bg-darkGrey relative py-[70px]">
        <div class="container">
            ...
            <div class="flex items-center gap-5 lg:justify-between">
                <!-- Form Card -->
                <form action="{{ route('front.payment.update', $booking->id) }}" class="bg-white p-[30px] pb-10 rounded-3xl max-w-[490px] w-full" method="POST" id="payment-form">
                    @csrf
                    @method('POST')
                    <div class="flex flex-col gap-[30px]">
                        ...
                        <div class="col-span-2 mt-5">
                            ...
                            <div class="p-1 rounded-full bg-primary group">
                                <a href="#!" id="submit" class="btn-primary">
                                    <p>
                                        Continue
                                    </p>
